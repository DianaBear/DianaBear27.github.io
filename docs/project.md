...
<section class="projects" id="projects">
    <div class="project-container">
        ...
        <div class="project-card" onclick="toggleProject(this)">
            ...
            <div class="project-preview">
                <img src="images/Miles.mp4" alt="Skincare App preview">
            </div>
        </div>
        ...
        <div class="project-card" onclick="toggleProject(this)">
            ...
            <div class="project-preview">
                <img src="images/womenCPSC.png" alt="Woman In Computer Science preview">
            </div>
        </div>
        ...
        <div class="project-card" onclick="toggleProject(this)">
            ...
            <p>This Portfolio site built with Jekyll and GitHub Pages.</p>
            <div class="project-preview">
