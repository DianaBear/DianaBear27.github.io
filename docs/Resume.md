...
<section class="resume">
    ...
    <div class="resume-container">
        <div class="resume-header">
            <h3>Diana Barakat</h3>
            <p>Email: <a href="mailto:dbaraka@clemson.edu">dbaraka@clemson.edu</a> | Phone: (Available upon request)</p>
            <p>LinkedIn: <a href="https://www.linkedin.com/in/dianabear/" target="_blank">Diana Barakat</a></p>
        </div>
        ...
        <div class="resume-item">
            <strong>Clemson University</strong> – Clemson, SC  
            <p>B.S. in Computer Information Systems | Minor in Cybersecurity</p>
            <p>August 2023 – May 2026 (Expected)</p>
        </div>
        <div class="resume-item">
            <strong>Tri-County Technical College</strong> – Pendleton, SC  
            <p>University Studies Certificate</p>
            <p>August 2021 – December 2022</p>
        </div>

        <h3>Relevant Coursework & Projects</h3>
        <div class="resume-item">
            <strong>Courses:</strong> Web Site Design, Intro to Programming Logic, C Programming, Microcomputer Applications, Algorithms and Data Structures, Computer Science I & II, Discrete Structures, Computer Ethics and Society, Problem Solving with Office Apps, Software Development Foundations, Human-Computer Interaction, Database Management Systems, Operating Systems, Networks & Network Programming, Computer Organization.
        </div>
        <div class="resume-item">
            ...
            <ul>
                <li>Linked List-Based Stacks and Queues</li>
                <li>Infix to Postfix Conversion</li>
                <li>Recursive Group Finder</li>
                <li>Searching and Sorting Algorithms</li>
                <li>Spell Checker Using Hash Table</li>
                <li>Closest Pair of Points Algorithm</li>
            </ul>
        </div>
        <div class="resume-item">
            <strong>Personal Projects:</strong> Weather Predictions Using Machine Learning (Python)
        ...
        <h3>Professional Experience</h3>
        <div class="resume-item">
            <strong>Finance Specialist – A&H Auto Sales</strong> – Greenville, SC  
            <ul>
                <li>Managed financial records including accounts payable/receivable and expense tracking.</li>
                <li>Assisted in budgeting and financial reporting to support management decisions.</li>
                <li>Streamlined processes to improve efficiency in financial record-keeping.</li>
            </ul>
        </div>
        <div class="resume-item">
            <strong>Financial Assistant – SB Trucking</strong>  
            <ul>
                <li>Organized and categorized expenses for 1099 tax submissions.</li>
                <li>Developed semi-automated accounting tools to streamline expense tracking.</li>
            </ul>
        </div>
        <div class="resume-item">
            <strong>IT Site Intern – Vertiv</strong>  
            <ul>
                <li>Provide on-site IT support and infrastructure assistance.</li>
                <li>Gain hands-on experience with enterprise systems, cloud infrastructure, and technical operations in a global technology company.</li>
            </ul>
        </div>
        ...
        <div class="resume-item skills">
            <ul>
                <li>Programming: C, C++, Python, JavaScript (intro)</li>
                <li>Operating Systems & Tools: Linux, Microsoft Access</li>
                <li>Certifications: Microsoft Office Specialist (MOS)</li>
            </ul>
        </div>
